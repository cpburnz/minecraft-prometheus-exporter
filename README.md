...
use, and does not need to be installed client-side. This is currently has builds
...
[output.txt]: https://github.com/cpburnz/minecraft-prometheus-exporter/blob/mc1.16.5/examples/output.txt
[prometheus_exporter-server.toml]: https://github.com/cpburnz/minecraft-prometheus-exporter/blob/mc1.16.5/examples/prometheus_exporter-server.toml
