...
public class Config {
    ...
    private static class InternalSpec {
        ...
        public InternalSpec(Configuration config) {
            ...
            this.collector_jvm.comment = "Enable collecting metrics about the JVM process.";

            this.collector_mc = config.get("collector", "mc", true);
            this.collector_mc.comment = "Enable collecting metrics about the Minecraft server.";
            ...
            this.web_listen_address.comment = "The IP address to listen on. To only allow connections from the local "
            ...
            this.web_listen_port.comment = "The TCP port to listen on. Ports 1-1023 will not work unless "
